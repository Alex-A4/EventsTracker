...
class EventModelWithStatisticForSettings {
  ...
  final List<EventTaskWithStatisticForSettings> tasks;
...
/// While [EventModelWithStatisticForSettings] is a general plan, for example, `Boxing`.
/// [EventModelWithStatisticForSettings] is a sub-task of `Boxing`, for example:
