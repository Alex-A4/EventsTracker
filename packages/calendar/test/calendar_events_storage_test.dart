...
void main() {
  ...
  final day1Json = CalendarActivityMapperToDto(day1).transform().toJson();
  final day2Json = CalendarActivityMapperToDto(day2).transform().toJson();
  ...
  group('CalendarActivitiesStorage.increaseDayActivity', () {
    ...
    test('increaseDayActivity when was data before', () async {
      SharedPreferences.setMockInitialValues({
        _storageKey: jsonEncode([day1Json]),
      });
      await initStorage();
      await storage.increaseDayActivity(
        date: day1.date,
  ...
  group('CalendarActivitiesStorage.decreaseDayActivity', () {
    ...
    test('decreaseDayActivity do not affect other day', () async {
      SharedPreferences.setMockInitialValues({
        _storageKey: jsonEncode([day1Json, day2Json]),
      });
      await initStorage();
